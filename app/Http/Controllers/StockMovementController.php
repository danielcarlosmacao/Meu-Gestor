...
class StockMovementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'type' => 'required|in:input,output,movement',
            ...
            'items.*.movement_type' => 'required_if:type,movement|in:input,output',
        ]);
        ...
        foreach ($validated['items'] as $item) {
            ...
            // Descobre qual operação será realizada
            if ($validated['type'] == 'movement') {
                $operation = $item['movement_type'];
            } else {
                $operation = $validated['type'];
            }
