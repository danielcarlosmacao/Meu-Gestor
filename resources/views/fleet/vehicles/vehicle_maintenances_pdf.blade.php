            ...
            @foreach ($vehicles as $vehicle)
                ...
                @if($totalMaintenances > 0)
                    <td>
                        ...
                        <div class="card-info"><strong>Última Km:</strong> {{ is_numeric($lastMileage) ? number_format($lastMileage, 0, ',', '.') . ' km' : '-' }}</div>
                        <div class="card-info"><strong>Valor Total:</strong> R$ {{ number_format($totalCost, 2, ',', '.') }}</div>
                    </td>
