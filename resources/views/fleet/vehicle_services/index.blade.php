                ...
                @foreach ($services as $service)
                    ...
                    <div class="modal fade" id="editServiceModal{{ $service->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('fleet.vehicle_services.update', $service->id) }}" method="POST">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editServiceModalLabel{{ $service->id }}">Editar Serviço
                                        </h5>
                            ...
                            @can('fleets.delete')
                            <form action="{{ route('fleet.vehicle_services.destroy', $service->id) }}" method="POST"
                                style="display:inline-block;" onsubmit="return confirm('Excluir este serviço?');">
                                @csrf
                                @method('DELETE')
