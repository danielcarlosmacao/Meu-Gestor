                        ...
                        @foreach($vels as $vel => $tipos)
                            @foreach($tipos as $tipo => $dados)
                                <tr class="
                                    ...
                                    @elseif(Str::endsWith($cfop, '07')) table-warning
                                    @endif
                                ...
                                ">
                                    ...
                                    <td class="text-center">
                                        <span class="badge {{ $tipo === 'dedicado' ? 'bg-success' : 'bg-secondary' }}">
                                            {{ ucfirst($tipo) }}
                                        </span>
                                    </td>
                                    <td class="text-center">
...
<style>
    .ibge-highlight {
        font-weight: bold;
        background-color: #f0f8ff !important; /* azul bem suave */
    }
    .ibge-highlight td {
                ...
                <tbody>
                    @forelse($notas as $nota)
                        <tr>
                            ...
                            <td class="text-center">{{ $nota['login'] }}</td>
