...
<div class="position-fixed top-0 end-0 p-3" style="z-index: 1080">
  <div id="invalidDateToast" class="toast align-items-center text-bg-warning border-0" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="d-flex">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const bsToast = new bootstrap.Toast(toastEl, { delay: 4000 }); // 4 segundos
        ...
        document.querySelectorAll('input[type="date"][name="start_date"]').forEach(function (input) {
            ...
            input.addEventListener('change', function () {
                ...
                if (['5', '6', '4'].includes(String(dayOfWeek)) && lastWarnedDate !== dateStr) {
                    toastMessage.textContent = `⚠️ Atenção: Você selecionou uma data de inicio de ferias que pode nao esta de acordo com as normas trabalhistas.`;
                    bsToast.show();
