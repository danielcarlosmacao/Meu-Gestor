    ...
    <div class="row">
        @php
            $grupos = [
                ...
                'Gestor Extras' => fn($p) => str_contains($p->name, 'extra') || str_contains($p->name, 'recipients') || str_contains($p->name, 'notification') ||  str_contains($p->name, 'api') ||  str_contains($p->name, 'stock') || str_contains($p->name, 'tasks'),
