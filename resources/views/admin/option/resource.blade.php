...
@section('content')
    <div class="admin-module-scope">
        ...
        <div class="container py-4">
            ...
            <form id="resourceSettingsForm" action="{{ route('options.resource.update') }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="hours_Generation" name="hours_Generation"
                                        ...
                                        value="{{ old('hours_Generation', $options['hours_Generation'] ?? 5) }}"
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <label for="themer" class="form-label">
                                    Tema do sistema
                                    <span class="text-danger">*</span>
                                </label>

                                <select id="themer" name="themer"
                                    class="form-select @error('themer') is-invalid @enderror" required>

                                    @foreach ($themes as $theme)
                                        <option value="{{ $theme }}" @selected(old('themer', $currentTheme) === $theme)>
                                            {{ \Illuminate\Support\Str::headline(pathinfo($theme, PATHINFO_FILENAME)) }}
                                        </option>
                                    @endforeach
                                ...
                                <div class="form-text">
                                    Define o arquivo visual carregado em todo o sistema.
                                </div>
...
====================================================== --}}
            ...
            <div
                class="settings-actions d-flex flex-column flex-lg-row justify-content-between align-items-stretch align-items-lg-center gap-3">

                <div class="settings-actions-group d-flex flex-column flex-sm-row gap-2">

                    <button type="button" class="btn btn-warning settings-action-btn"
                        onclick="mostrarPopupConfirmacao()">
                        <i class="bi bi-tools"></i>
                        <span>Reparar Torres</span>
                    </button>

                    <form id="clearCacheForm" action="{{ route('options.cache.clear') }}" method="POST" class="m-0"
                        onsubmit="return confirm('Deseja limpar todos os caches do sistema?');">
                        @csrf

                        <button type="submit" class="btn btn-outline-danger settings-action-btn">
                ...
                <button type="submit" class="btn dcm-btn-primary settings-action-btn settings-save-btn"
